...
cc.Class({
    ...
    preloadAudioClip() {
        ...
        for (let index = 0; index < soundArry.length; index++) {
            ...
            cc.resources.load(element, cc.AudioClip, (err, audioClip)=> {
                if (!err && this) {
    ...
    playSoundByNameInResources(soundName, loop){
        ...
        if (clip) {
            ...
            cc.resources.load("sound/" + soundName, cc.AudioClip, (err, audioClip) => {
                if (!err) {
                    this.soundAudioClips[audioClip._name] = audioClip;
    ...
    playLobby() {
        ...
        if (clip) {
            ...
            cc.resources.load("sound/lobby", cc.AudioClip, (err, audioClip) => {
                if (!err) {
                    this.soundAudioClips[audioClip._name] = audioClip;
    ...
    playButton() {
        ...
        if (clip) {
            ...
            cc.resources.load("sound/button", cc.AudioClip, (err, audioClip) => {
                if (!err) {
                    this.soundAudioClips[audioClip._name] = audioClip;
    ...
    playBack() {
        ...
        if (clip) {
            ...
            cc.resources.load("sound/back", cc.AudioClip, (err, audioClip) => {
                if (!err) {
                    this.soundAudioClips[audioClip._name] = audioClip;
                    this.playSound(audioClip, false);
                }
