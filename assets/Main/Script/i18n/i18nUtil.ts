...
export enum I18NLabelTransIdEnum {
    ...
    'MyVip_Add cash 5 now to become a VIP player.',
    'MyVip_VIP Rules',
    'MyVip_Level up gift',
...
export class I18NUtil {
    ...
    private _initLanguageMap() {
        ...
        this.EnglishMap.set(I18NLabelTransIdEnum['MyVip_Add cash 5 now to become a VIP player.'], 'Add cash 5 now to become a VIP player.');
        ...
        this.HindiMap.set(I18NLabelTransIdEnum['MyVip_Add cash 5 now to become a VIP player.'], 'वीआईपी खिलाड़ी बनने के लिए अभी नकद 200 जोड़ें।');
        ...
        this.BengaliMap.set(I18NLabelTransIdEnum['MyVip_Add cash 5 now to become a VIP player.'], 'ভিআইপি প্লেয়ার হতে এখন নগদ 200 যোগ করুন।');
        ...
        this.UrduMap.set(I18NLabelTransIdEnum['MyVip_Add cash 5 now to become a VIP player.'], 'VIP کھلاڑی بننے کے لیے ابھی 200 کیش شامل کریں۔');
