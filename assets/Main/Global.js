...
window.GlobalCfg = {
    ...
    CLIENT_MSG_ID: {
        ...
        GD_LOBBY_LOAD_COMPLETE: "GD_LOBBY_LOAD_COMPLETE",
        CHANGE_SCENE_COMPLETE: "CHANGE_SCENE_COMPLETE",
        GD_SMALLGAME_LOAD_PROGRESS: "GD_SMALLGAME_LOAD_PROGRESS", //大厅小游戏下载进度
        GD_LOBBY_LOAD_PROGRESS: "GD_LOBBY_LOAD_PROGRESS", //大厅系统图标下载进度
...
function SetPackageChannel() {
    ...
    if (!pkg || pkg.length === 0) {//如果不存在强制设置5_2001
        pkg = "5_2001";
    }
