...
cc.Class({
    ...
    showNode:function(str,type){
        if(str == "redDot") {
            ...
            let cardspritename = ''
            let sprite = this.node_winColor.getComponent(cc.Sprite);
            let lab_cradTpye = this.node_winColor.getChildByName("lab_cradTpye").getComponent(cc.Label);
            if(type == 5){
