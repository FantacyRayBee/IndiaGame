...
cc.Class({
     ...
     * @param {下注类型} side 
     */
    CallReq:function(amount,side,packageName){
        ...
        if(self.stopBetState) {
            ...
            if(GlobalCfg.USER_DATAS.isNotCharge == true && GlobalCfg.USER_DATAS.gamePattern == 0 && GlobalCfg.USER_DATAS.refuseUnpayHundred[packageName] == true && GlobalCfg.isPayGame == true) {  //未曾充值
