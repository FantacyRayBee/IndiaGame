cc.Class({
    ...
    loadGameSound: function() {
        CommonFun.getInstance().loadBundle('zeusGame', (bundle) => {
            bundle.loadDir('audios', cc.AudioClip, (err, audioClipArr) => {
                if (!err) {
                    for (let i = 0, len = audioClipArr.length; i < len; i++) {
                        let audioClip = audioClipArr[i];
     ...
     * 播放scatter音效
     */
    playScatterTriggerEffect: function() {
     ...
     * 播放到达底部音效
     */
    playReachBottomEffect: function() {
     ...
     * 播放点击1.25倍时音效
     */
    playClick125TimesEffect: function() {
     ...
     * 播放点击spin按钮音效
     */
    playClickSpinBtnEffect: function() {
     ...
     * 播放点击普通按钮音效
     */
    playClickNormalBtnEffect: function() {
     ...
     * 播放打开Free提示框时音效
     */
    playBuyFreeTipsShowEffect: function() {
     ...
     * 播放关闭Free提示框时音效
     */
    playBuyFreeTipsHideEffect: function() {
     ...
     * 播放点击Free提示框确定按钮音效
     */
    playBuyFreeTipsCliclOkEffect: function() {
