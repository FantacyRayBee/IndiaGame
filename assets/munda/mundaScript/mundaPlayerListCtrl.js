cc.Class({
    ...
    setTCWJData: function (list, total) {
        if (!list) {
        ...
        for (let i = 0, len = list.length; i < len; i++) {
            let playerItem = cc.instantiate(this.pab_playerItem);
            let script = playerItem.getComponent('mundaPlayerItemCtrl');
