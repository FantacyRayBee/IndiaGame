...
@ccclass
export default class PgGameTopNode extends cc.Component {
    // private static instance: PgGameTopNode
    // public static getInstance(): PgGameTopNode {
    //     if (!this.instance) {
    //         this.instance = new PgGameTopNode();
    //     }
