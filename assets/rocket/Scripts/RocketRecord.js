...
cc.Class({
    ...
    init(data) {
        ...
        let dataArray = this.dealData(data);
    ...
    initPoint(dataArray) {
        ...
        let originalX = -608, originalY = 65, offsetX = 32, offsetY = 32;
        for (let i = 0; i < data.length; i++) {
            for (let j = 0; j < data[i].length; j++) {
                ...
                let posx = originalX + offsetX * i, posy = originalY - offsetY * j;
                let node = cc.instantiate(this.prefabPoint);
    ...
    dealData(array) {
        ...
        let i = 0, j = -1, defaultNum = null, resultArr = [];
        while (i < len) {
