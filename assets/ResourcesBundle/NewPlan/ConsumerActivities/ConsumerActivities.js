...
cc.Class({
    ...
    initItemNode(data, index, unShowNum = false , itemLength) {
        ...
        if (percent >= 1) {
            ...
            labelGet.string = CommonFun.getInstance().formatCurrencyAmount(CommonFun.getInstance().numberToShow(rebate));
        ...
        if(index == itemLength -1){
            // 特殊对待最后一项，展示出来
            labelGet.string = CommonFun.getInstance().formatCurrencyAmount(rebate);
        }
