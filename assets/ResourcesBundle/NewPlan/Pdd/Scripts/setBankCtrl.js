cc.Class({
    ...
    init() {
        ...
        if (this.bankCradInfo) {
            ...
            this.bankCradInfo = { bankName: "HDFC BANK", bankCard: "", IFSCode: "", bankHolder: "", bankCardPhone: "",bankEmail: "" };
        }
    ...
    initEditBoxString: function (bankCradInfo) {
    ...
    setBankInfoToLocal: function () {
        cc.sys.localStorage.setItem("bankCradInfo", JSON.stringify(this.bankCradInfo));
        let turnTableCtrl = this.node.parent.getComponent('turnTableCtrl');
    ...
    withDraw: function () {
        let url = GlobalCfg.HTTP_SERVER + "/v1/pdd/withdraw";
    ...
    showBankList: function () {
        ...
        let content = this.bankScrollView.content;
    ...
    itemButtonClick: function (button) {
        let bankName = button.node.getChildByName("lab_bank").getComponent(cc.Label).string;
