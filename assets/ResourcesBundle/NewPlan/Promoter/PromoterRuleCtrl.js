cc.Class({
    ...
    //实例化玩家领奖情况的预制
    insHistoricalRecords:function(){
        LoggerUtil.getInstance().log("insHistoricalRecords this.userList: ", this.userList);
        LoggerUtil.getInstance().log("insHistoricalRecords length: ", this.userList.length);
