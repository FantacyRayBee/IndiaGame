cc.Class({
    ...
    btnClick: function (sender) {
        let senderName = sender.node.name;
    ...
    SetToggle: function (senderName, index) {
    ...
    InitToggle: function (senderName, index) {
    ...
    setBtnTuiChui: function () {
        this.BtnTuiChu.node.active = false
    },

    setLobbyBgType: function (type) {
    ...
    setLabelsByLanguageType: function(languagesType) {
        let versionStr = I18NUtil.getInstance().getLanguageStr(languagesType, I18NLabelTransIdEnum['Lobby_Version']);
