        ...
        if (CommonFun.getInstance().isValidForScr(this)) {
            for (let i = 0; i < 2; i++) {
                ...
                if (i == 0) {
                    ...
                    this.lab_cash1.string = CommonFun.getInstance().formatCurrencyAmount(amount);
                    this.lab_addCash1.string = CommonFun.getInstance().formatCurrencyAmount(price);
                    this.lab_bonus1.string = CommonFun.getInstance().formatCurrencyAmount(bonus);
                    this.lab_totalGet1.string = CommonFun.getInstance().formatCurrencyAmount(total);
                    this.lab_percent1.string = `${percent}`;
                    this.price1 = price
                }
                else if (i == 1) {
                    this.secondCommodityId = data.id;
                    this.lab_cash2.string = CommonFun.getInstance().formatCurrencyAmount(amount);
                    this.lab_addCash2.string = CommonFun.getInstance().formatCurrencyAmount(price);
                    this.lab_bonus2.string = CommonFun.getInstance().formatCurrencyAmount(bonus);
                    this.lab_totalGet2.string = CommonFun.getInstance().formatCurrencyAmount(total);
