(function () {
  ...
  var Protocol = require('./protocol'); //window.Protocol;
  var protobuf = require('./protobuf'); //window.protobuf;
  ...
  var EventEmitter = require('./emitter'); //window.EventEmitter;
  var rsa = window.rsa;
  ...
  // pomelo.create = function() {
  //   return Object.create(pomelo);
  // }
  ...
  pomelo.init = function (params, cb) {
    ...
    params.sendEvent ? sendEvent = params.sendEvent : 0;
    ...
    var onclose = function (event) {
      ...
      if (!!params.reconnect && reconnectAttempts < maxReconnectAttempts) {
        ...
        reconncetTimer = setTimeout(function () {
          pomelo.emit('tryconnect', reconnectAttempts);
  ...
  pomelo.request = function (route, msg, cb) {
    ...
    //console.log("pomelo.request", reqId, route);
    callbacks[reqId] = cb;
  ...
  var heartbeat = function (data) {
    ...
    //jsclient.gamenet.ComputeNetDelayByHeartBeat();
    var obj = Package.encode(Package.TYPE_HEARTBEAT);
    if (heartbeatTimeoutId) {
      clearTimeout(heartbeatTimeoutId);
      heartbeatTimeoutId = null;
    }
    sendEvent ? sendEvent("heartbeat", 1) : pomelo.emit('heartbeat');
    ...
    heartbeatId = setTimeout(function () {
      //jsclient.gamenet.resetHeartBeatTime();
      heartbeatId = null;
      send(obj);
    ...
    if (Array.isArray(msgs)) {
      for (var i = 0; i < msgs.length; i++) {
        ...
        if (handlers_msg) handlers_msg(msg.body);
          ...
          sendEvent ? sendEvent("disconnect", 3) : pomelo.emit('disconnect', 3);
        }
      }
    } else {
      ...
      if (handlers_msg) handlers_msg(msgs.body);
        ...
        sendEvent ? sendEvent("disconnect", 4) : pomelo.emit('disconnect', 4);
      }
    }
  };

  var processMessage = function (pomelo, msg) {
    //console.log("pomelo.processMessage ", msg.id, msg.route);
    if (!msg.id) {
      // server push message
