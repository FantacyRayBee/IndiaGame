"use strict";
cc._RF.push(module, 'bdd8e/goCVBC49/7klYevMX', 'PromoterCtrl');
// ResourcesBundle/NewPlan/Promoter/PromoterCtrl.js
...
cc.Class({
  ...
  showBtnWhatsApp: function showBtnWhatsApp(bool) {
  ...
  setTuiGuangYuanMainViewLanguage: function setTuiGuangYuanMainViewLanguage() {
    // 1是英文 2是印地语 3乌尔都 4孟加拉语  默认英语 
    var teamTipsStr = "";
    var outIncomeTipsStr = "";
    var invitedIncomeTipsStr = "";
    var totalBonusTipsStr = "";
    var teamTipsViewTipsStr = "";
    var opuPutTipsViewTipsStr = "";
    var inviteTipsViewTipsStr = "";
    var bonusTipsViewTipsStr = "";
    var btnFXStr = "";
    var btnFZStr = "";
    var btnSFStr = "";
    var btnTeamStr = "";
    var btnHistoryStr = "";
    var btnBonusTableStr = "";
    var btnGetStr = "";
    var bgLabForStr = "";
    var bgLabYouCanStr = "";
    var bgLabShareStr = "";
  ...
  dealBtnMainCloseEvent: function dealBtnMainCloseEvent() {
    this.node.destroy();
  },
  ...
  dealBtnFXEvent: function dealBtnFXEvent() {
    var shareText = "Your cash will expire in three hours, download the No.1 card game in US to receive your cash, do not let it go！";
    var inviteCode = GlobalCfg.CHANNEL_INFO + "_" + GlobalCfg.USER_DATAS.inviteCode;
    var shareUrl = GlobalCfg.APP_SHARE_URL + "?inviteCode=" + inviteCode;

    // 只拼接，保持最终是明文
    var finalStr = shareText + " " + shareUrl;
    // 输出或分享
  ...
  dealBtnHistoryEvent: function dealBtnHistoryEvent() {
    this.showLeftView("historyView");
  },
  dealBtnBonusTableEvent: function dealBtnBonusTableEvent() {
    this.showLeftView("bonusView");
  },
  dealBtnTeamTipsEvent: function dealBtnTeamTipsEvent() {
    this.node_teamTipsView.active = true;
  },
  dealBtnOutPutTipsEvent: function dealBtnOutPutTipsEvent() {
    this.node_opuPutTipsView.active = true;
  },
  dealBtnInvitedTipsEvent: function dealBtnInvitedTipsEvent() {
    this.node_inviteTipsView.active = true;
  },
  dealBtnTotalTipsEvent: function dealBtnTotalTipsEvent() {
    this.node_bonusTipsView.active = true;
  },
  dealBtnGetEvent: function dealBtnGetEvent() {
    var self = this;
    var httpUrl = GlobalCfg.HTTP_SERVER + "/v1/promoter/income/receive";
    CommonFun.getInstance().httpGet(httpUrl, function (msg) {
      if (msg.result == 0) {
  ...
  setGetBonusResult: function setGetBonusResult(data) {
    if (!data) {
      return;
    }
    ;
    ...
    var totalBonus = data.total_bonus;
  ...
  dealBtnTeamTipsViewEvent: function dealBtnTeamTipsViewEvent() {
    this.node_teamTipsView.active = false;
  },
  dealBtnOutPutTipsViewEvent: function dealBtnOutPutTipsViewEvent() {
    this.node_opuPutTipsView.active = false;
  },
  dealBtnInviteTipsViewEvent: function dealBtnInviteTipsViewEvent() {
    this.node_inviteTipsView.active = false;
  },
  dealBtnBonusTipsViewEvent: function dealBtnBonusTipsViewEvent() {
    this.node_bonusTipsView.active = false;
  },
  showLeftView: function showLeftView(typeStr) {
