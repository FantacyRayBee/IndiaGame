"use strict";
cc._RF.push(module, '68b87weBK9HrpXGbqKAe9Xv', 'ActivityChallengesItemCtrl');
// ResourcesBundle/NewPlan/Activity/ActivityChallengesItemCtrl.js
...
cc.Class({
  ...
  setChallengesItemCollectComplete: function setChallengesItemCollectComplete() {
    this.btn_play.node.active = false;
    this.btn_collect.node.active = false;
  },
  setChallengesItemOpenStatus: function setChallengesItemOpenStatus() {
    this.node_state1.active = true;
    this.node_state2.active = false;
    this.btn_play.node.active = true;
    this.btn_collect.node.active = false;
  },
  getChallengesItemState: function getChallengesItemState() {
