"use strict";
cc._RF.push(module, 'e2359HDby1AJ6NiPaxx0qxl', 'ShopNewTipCtrl');
// ResourcesBundle/NewPlan/Shop/ShopNewTipCtrl.js
...
cc.Class({
  ...
  waitForSeconds: function waitForSeconds(time) {
    var _this = this;
    if (time === void 0) {
      time = 0;
    }
    ...
    return _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
      ...
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          ...
          case 9:
            fadeIn = cc.fadeIn(1); // 参数表示动作持续的时间，单位为秒
            _this2.btn_get.node.runAction(fadeIn);
            _this2.btn_get.interactable = true;
          case 12:
          case "end":
