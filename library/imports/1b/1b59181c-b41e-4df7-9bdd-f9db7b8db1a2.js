...
cc.Class({
  ...
  ctor: function ctor() {
    this.showNodePos = [cc.v2(0, 247), cc.v2(80, 247), cc.v2(160, 247), cc.v2(240, 247),
    //上边
    cc.v2(240, 163), cc.v2(240, 83), cc.v2(240, 3), cc.v2(240, -77), cc.v2(240, -157), cc.v2(240, -237),
    //右边
    cc.v2(160, -237), cc.v2(80, -237), cc.v2(0, -237), cc.v2(-80, -237), cc.v2(-160, -237), cc.v2(-240, -237),
    //下边
    cc.v2(-240, -157), cc.v2(-240, -77), cc.v2(-240, 3), cc.v2(-240, 83), cc.v2(-240, 163), cc.v2(-240, 247),
    //左边
  ...
  initLogo: function initLogo(logoPab, parentNode) {
    ...
    for (var i = 0; i < this.showNodePos.length; i++) {
      ...
      var spriteLogo = logo.getChildByName("logo").getComponent(cc.Sprite);
