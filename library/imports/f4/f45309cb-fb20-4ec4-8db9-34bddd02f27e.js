"use strict";
cc._RF.push(module, 'f4530nL+yBOxI25NL3dAvJ+', 'ShopInstructionsCtrl');
// ResourcesBundle/NewPlan/Shop/ShopInstructionsCtrl.js
...
cc.Class({
  ...
  start: function start() {
    ...
    var enumItemTypeArr = ["rechargeTips", "rewardTips", "winningsTips", "depositTips"];
  ...
  showAnswerItem: function showAnswerItem(enumType) {
    var answerItemLen = {
      "rechargeTips": 2,
      "withdrawalTips": 5,
      "rewardTips": 1,
