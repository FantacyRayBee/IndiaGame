"use strict";
cc._RF.push(module, 'af677BQ7vtIT71/25WO9KAb', 'zooRouletteManager');
// zooGame/Scripts/zooRouletteManager.js
...
cc.Class({
  ...
  startRotate: function startRotate(aniType, remainder) {
    ...
    LoggerUtil.getInstance().log("\u8F6C\u76D8\u4E2A\u6570\uFF1Alength:" + length + ",\u7ED3\u675F\u6162\u901F\u9636\u6BB5\u4E2A\u6570:" + this.endStageItemNums); // 转盘开始慢速阶段 →  转盘正常快速阶段 →  转盘结束慢速阶段
              ...
              return _context2.abrupt("return", new Promise(function (resolve, reject) {
                _this3.scheduleOnceCallback = function () {
                  ...
                  if (index !== itemArr.length - 1) {
                    ...
                    _this3.itemRoulettes(itemNode, "slow", true);
                  }
