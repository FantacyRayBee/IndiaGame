"use strict";
cc._RF.push(module, '4a7f86nhaxFZazdRDDh/Z+4', 'cricketSeatManager');
// cricketGame/scripts/cricketSeatManager.js
  ...
  seatNodePlayerBet: function seatNodePlayerBet(id) {
    ...
    if (seatNode) {
      ...
      cc.tween(seatNode).to(0.1, {
        position: cc.v2(seatNode.x, y + 20)
      }).to(0.1, {
        position: cc.v2(seatNode.x, y)
      }).start();
    }
  },
  /**
