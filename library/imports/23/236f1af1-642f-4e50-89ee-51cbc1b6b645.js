"use strict";
cc._RF.push(module, '236f1rxZC9OUInuUcvBtrZF', 'protobuf');
// Main/Script/Common/Net/protobuf.js
  ...
  /* end of prelude */
    ...
    5: [function (require, module, exports) {
      ...
      function fetch(filename, options, callback) {
        ...
        cc.resources.load(filename, function (err, data) {
          if (err) {
            return callback(err, null);
          }

          if (options.binary) {
            var buffer = data.text;

            if (!buffer) {
              buffer = [];

              for (var i = 0; i < data.text.length; ++i) {
                buffer.push(data.text.charCodeAt(i) & 255);
              }
            }
    ...
    23: [function (require, module, exports) {
      ...
      Namespace.prototype.lookupType = function lookupType(path) {
        var found = this.lookup(path, [Type]); // if (!found)
