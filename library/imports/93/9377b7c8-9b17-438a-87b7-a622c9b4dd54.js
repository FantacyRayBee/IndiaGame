...
cc.Class({
  ...
  sendCallReq: function sendCallReq() {
    var _this6 = this;
    if (GlobalCfg.IS_CLUB_MODE == 0 && GlobalCfg.USER_DATAS.isNotCharge == true && GlobalCfg.USER_DATAS.gamePattern == 0 && GlobalCfg.USER_DATAS.refuseUnpayHundred["minishuiguo"] == true) {
      //未曾充值
