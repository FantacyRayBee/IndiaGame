"use strict";
cc._RF.push(module, '931e2wllqFOy7x5hJ/ncTCk', 'playerCtrl');
// munda/mundaScript/playerCtrl.js
...
cc.Class({
  ...
  ctor: function ctor() {
    ...
    this.Wincoin = 0;
    this.diamond = 0;
    this.vipNodePosArr = [cc.v2(567, -185), cc.v2(567, -5), cc.v2(567, 172), cc.v2(-568, 172), cc.v2(-568, -5), cc.v2(-568, -185)];
  },
  ...
  setPlayerInfo: function setPlayerInfo(data, isLogin, mainCtrl) {
    if (isLogin === void 0) {
      isLogin = false;
    }
    if (mainCtrl === void 0) {
  ...
  setCoin: function setCoin(coin, isSelf) {
    if (isSelf === void 0) {
      isSelf = false;
    }
    this.coin = coin / 100;
  ...
  //设置VIP节点的坐标
  setVipNodePos: function setVipNodePos(siteID) {
   ...
   * @returns {cc.v2}
   */
  getVipNodePos: function getVipNodePos(siteID) {
  ...
  face: function face(notify) {
    ...
    if (msgtype == 0) {
      ...
      cc.tween(this.node_emotion).repeat(4, cc.tween().by(0.5, {
        ...
        _this2.node_emotion.active = false;
