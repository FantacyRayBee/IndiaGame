"use strict";
cc._RF.push(module, '49b30Jf0flOsp+Yereb9loK', 'teenPattiWanFaCtrl');
// teenPatti/src/teenPattiWanFaCtrl.js
...
cc.Class({
  ...
  onLoad: function onLoad() {
    ...
    var titleArr = [null, this.viewList["english_title"], this.viewList["hindi_title"], this.viewList["Urdu_title"], this.viewList["Bengali_title"]];
    titleArr[language].active = true, this.node_btn_ok = this.viewList["btn_ok"];
  ...
  setTeenPattiWaFanView: function setTeenPattiWaFanView(data) {
    if (!data) {
      return;
    }
    ;
    ...
    this.lab_1.string = teenPattiLanguage.lab_bootAmountTips[language], this.lab_2.string = teenPattiLanguage.lab_chaalLimitTips[language], this.lab_3.string = teenPattiLanguage.lab_maxBlindsTips[language], this.lab_4.string = teenPattiLanguage.lab_potLimitTips[language], this.lab_ok.string = playerCenterLanguage.lab_Okay[language], this.lab_bootAmount.string = data.cellScore / 100;
