"use strict";
cc._RF.push(module, 'd9423GmTExD9I+ISQ8B6U4a', 'Global');
// Main/Global.js
...
window.GlobalCfg = (_window$GlobalCfg = {
  ...
  */
  ...
  CLIENT_MSG_ID: (_CLIENT_MSG_ID = {
    ...
    FIRST_RECHARGE_TIPS: "FIRST_RECHARGE_TIPS",
    // 首充提示
    EXIT_GAME: "EXIT_GAME",
    ...
    SIDEBAT_DISPLAYED: "sidebar_displayed",
    // 侧边栏显示
  ...
  }, _CLIENT_MSG_ID["RECHARGED_DAILYBONUS_CARD"] = "RECHARGED_DAILYBONUS_CARD", _CLIENT_MSG_ID.ACTIVITY_GOBETTING_GET = "ACTIVITY_GOBETTING_GET", _CLIENT_MSG_ID.TPGAME_CLICK_RECHARGE = "TPGAME_CLICK_RECHARGE", _CLIENT_MSG_ID.TPGAME_CLICK_LUCKYPLAYER_GET = "TPGAME_CLICK_LUCKYPLAYER_GET", _CLIENT_MSG_ID.SAVE_AUTOSPIN = "SAVE_AUTOSPIN", _CLIENT_MSG_ID),
  /**
   * 埋点事件名称
   */
  BEHAVIOR_TYPE: {
...
}, _window$GlobalCfg["APP_SERVER_ERR_CODE"] = {
  REPEAT_LOGIN: 9,
  // 重复登录
  SERVER_RELOAD: 29 // 服务器重启
