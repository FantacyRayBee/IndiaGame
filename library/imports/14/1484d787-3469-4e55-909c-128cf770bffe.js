"use strict";
cc._RF.push(module, '1484deHNGlOVZCcEoz3cL/+', 'shopAndWithDrawHelpCtrl');
// ResourcesBundle/prefab/lobby/shop/shopAndWithDrawHelpCtrl.js
...
cc.Class({
  ...
  onEventMsg: function onEventMsg(webData, target) {
    ...
    if (msgId == "SelectPhotoCallBack") {
      ...
      var byteData = jsb.fileUtils.getDataFromFile(self.photoPath);
      ...
      cc.assetManager.loadRemote(self.photoPath, function (err, img) {
