"use strict";
cc._RF.push(module, 'a4576OtNu1HLIB5P7Q+4LsU', 'ChangeNameCtrl');
// ResourcesBundle/NewPlan/Personal/ChangeNameCtrl.js
      ...
      CommonFun.getInstance().httpPost(GlobalCfg.HTTP_USER_LOGIN + '/v1/userinfoupdate', parm, function (jsonObj) {
        if (jsonObj.result == 0) {
          ...
          ClientNotify.send(GlobalCfg.MSG_TYPE.clientMsg, {
            ...
            msgData: {
              userHeadimgurl: GlobalCfg.USER_DATAS.userHeadimgurl,
