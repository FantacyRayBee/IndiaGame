"use strict";
cc._RF.push(module, '17910fNlK1JSIJGYXRRA+vg', 'RocketPlayerList');
// rocket/Scripts/RocketPlayerList.js
...
cc.Class({
  ...
  setPlayerData: function setPlayerData(notify) {
    ...
    for (var i = 0; i < playerlist.length; i++) {
      ...
      var ctrl = pab_player.getComponent("RocketPlayerItem");
  ...
  clickBtn: function clickBtn(button) {
    ...
    if (btnName == "btn_Prev") {
      ...
      if (this.page <= 1) {
        ...
        GlobalCfg.ACT_SCENE_CTRL.rocketMessageManager.sendGetPlayerListMessage(this.page - 1, 12);
      } else {
        GlobalCfg.ACT_SCENE_CTRL.rocketMessageManager.sendGetPlayerListMessage(this.page - 1, 12);
        this.lab_page.string = this.page + "/" + this.allPage;
        this.btn_next.target.getChildByName('lab_next').color = new cc.Color(255, 255, 255, 255);
